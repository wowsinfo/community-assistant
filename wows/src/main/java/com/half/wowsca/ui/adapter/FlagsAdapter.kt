 ...
 */
class FlagsAdapter(
    private val exteriorItems: List<ExteriorItem>?,
    private val ctx: Context,
    private val onFlagClicked: (Long) -> Unit = {},
) :
    ...
    inner class FlagsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
